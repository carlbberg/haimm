...
**1. Survey first, to scope.** Put the [S] criteria to the team, twenty-five items across the six dimensions. Treat the results as a map of where to look, not as findings. A team that answers yes to everything is telling you exactly where to be sceptical.
