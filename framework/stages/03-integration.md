...
What worked in a pilot becomes part of how the work gets done. Somebody arranges access, permissions and tooling so that using AI stops being an act of individual initiative. Norms appear for what AI contributes and what a person still owns, and context starts moving out of individual heads into something the team holds collectively.
...
- **Not Satir's integration phase.** The two share a word and do not line up. Satir's integration, where new practice settles and performance recovers, falls at HAIMM's Optimization. Satir's chaos falls here. Name the collision every time you use the two together.
- **Not scale.** Integration is depth in a single context. Whether that depth survives a handover to a second team belongs to Optimization, and assuming the two arrive together is probably the most common way a result gets overstated.
