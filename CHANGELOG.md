...
### Changed
- Every citation in `framework/` now verified. Mollick (2023), Moravec (1988) and Noessel (2017) moved from unverified, with the publication date and URL, the page for Moravec's paradox, and the ISBN added. The five Satir phase names the People dimension uses turned out to be Smith's (1997) rendering rather than Satir et al.'s (1991), so the dimension now cites both and names the difference, and Smith is added to the references. Only the enterprise models HAIMM positions against remain unverified, and they are cited as positioning rather than as evidence.
